...
class salestaxcalculatorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/salestaxcalculator');
        }
        ...
        this.validationRules = {"amount":{"type":"number","required":true,"min":0},"zip":{"type":"string","required":true,"minLength":5,"maxLength":5},"state":{"type":"string","required":false,"minLength":2,"maxLength":2}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/salestaxcalculator`);
        }
    }
...
module.exports = salestaxcalculatorWrapper;
