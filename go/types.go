// Package salestaxcalculator provides a Go client for the Sales Tax Calculator API.
//
// For more information, visit: https://apiverve.com/marketplace/salestaxcalculator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Sales Tax Calculator API.
//
// Parameters:
//   - amount (required): number - Purchase amount to calculate tax on [min: 0]
//   - zip (required): string - Valid US 5-digit ZIP code [minLength: 5, maxLength: 5]
//   - state: string - 2-letter US state code (e.g., CA, NY, TX) [minLength: 2, maxLength: 2]
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"state": {Type: "string", Required: false, MinLength: intPtr(2), MaxLength: intPtr(2)},
	}
...
// ResponseData contains the data returned by the Sales Tax Calculator API.
...
type BreakdownData struct {
	...
	CountyRate float64 `json:"countyRate"`
	CityRate float64 `json:"cityRate"`
	SpecialRate float64 `json:"specialRate"`
}
