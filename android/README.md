# Sales Tax Calculator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:salestaxcalculator-api:1.1.13'
}
```
...
```java
import com.apiverve.salestaxcalculator.SalesTaxCalculatorAPIClient;
import com.apiverve.salestaxcalculator.APIResponse;
import com.apiverve.salestaxcalculator.APIException;

// Initialize the client
SalesTaxCalculatorAPIClient client = new SalesTaxCalculatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/salestaxcalculator](https://docs.apiverve.com/ref/salestaxcalculator)
...
- **Documentation:** [https://docs.apiverve.com/ref/salestaxcalculator](https://docs.apiverve.com/ref/salestaxcalculator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/salestaxcalculator-api/issues)
