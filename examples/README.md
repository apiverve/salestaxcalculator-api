# Sales Tax Calculator API - Examples

This folder contains example code for using the Sales Tax Calculator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/salestaxcalculator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/salestaxcalculator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/salestaxcalculator](https://docs.apiverve.com/ref/salestaxcalculator)
